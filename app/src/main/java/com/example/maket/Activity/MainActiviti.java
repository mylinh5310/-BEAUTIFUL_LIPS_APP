...
//        mEdt_pass.setText(ps);
        ...
        mImageView_addacc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(MainActiviti.this,SignUpActivity.class);
        ...
        mImageView_Reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActiviti.this,ResetActivity.class);
                startActivity(intent);
            }
        });
    }
    private void login(){
        ...
        SharedPreferences preferences =MainActiviti.this.getSharedPreferences("login",MODE_PRIVATE);
        ...
        Intent intent = new Intent(MainActiviti.this,HomeActivity.class);
        startActivity(intent);
    }
